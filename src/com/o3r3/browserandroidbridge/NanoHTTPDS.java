...
public abstract class NanoHTTPDS {
    /**
     ...
     */
    public NanoHTTPDS(String hostname, int port) {
...
//         KeyStore keystore = KeyStore.getInstance("JKS");
          // Intentando cambiar de formato para ver si se lo traga o que
         KeyStore keystore = KeyStore.getInstance("BKS");
         InputStream keystoreStream = NanoHTTPDS.class.getResourceAsStream(keyAndTrustStoreClasspathPath);
...
//         throw new IOException(e);
          Log.e(PCBridgeActivity.tag, "Problemas con la cosa del ssl");
      }
      return res;
   }
